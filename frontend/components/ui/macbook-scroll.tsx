  ...
  return (
    ...
    >
      <motion.h2
        ...
        className="dark:text-white mt-0 pt-0  text-neutral-800 text-3xl font-bold text-center"
      >
      ...
      />
      {/* Base area */}
      <div className="h-[22rem] mt-0 pt-0  w-[32rem] bg-gray-200 dark:bg-[#272729] rounded-2xl overflow-hidden relative -z-10">
        {/* above keyboard bar */}
